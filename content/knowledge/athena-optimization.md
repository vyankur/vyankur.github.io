...
## Topics Covered
- [x] Athena Serverless Mechanics\n- [x] S3 Partitioning Strategies\n- [x] Columnar File Formats (Parquet/ORC)\n- [x] Query Tuning & Execution Plans\n- [x] Cost Management and Scan Limits
